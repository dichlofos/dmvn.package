...
\author{\copyright{} 2004--2015, DMVN Corporation}
\date{Версия пакетов \dmvnversion, последнее обновление: \сегодня~г.}
...
\hline \texttt{dots/nodots} & Есть точки точки после номеров секций \итп/Точек нет\\
...
Он может быть полезен, если документ небольшой. Кроме того, нумерация теорем \итп в~этом случае
...
он конфликтует с командами для рисования типа \verb'\circle', \verb'\line', \verb'\put' \итд
